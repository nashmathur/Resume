...
\address{Residency: French | Nationality: Indian}

% \mobile{(+82) 10-9030-1843}
\email{natansh.mathur@qcware.com}
\homepage{nashmathur.github.io}
\github{nashmathur}
\linkedin{natanshmathur}
\scholar{ftgCfMEAAAAJ}
% \gitlab{gitlab-id}
